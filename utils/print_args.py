def print_args(args,logger):
    ...
    logger.info('========================================================================================================================')
    logger.info('==========================================  One Experiment Separation  =================================================')
    logger.info('========================================================================================================================')
    ...
    print(f'  {"Num Workers:":<20}{args.num_workers:<20}{"Exp_times:":<20}{args.exp_times:<20}')
    logger.info(f'  {"Num Workers:":<20}{args.num_workers:<20}{"Exp_times:":<20}{args.exp_times:<20}')
